  ...
  <div>
    ...
    >
      ...
      <b-form-group
        ...
        <b-form-tags input-id="params" v-model="params" duplicate-tag-text="Duplicate parameter"></b-form-tags>
      </b-form-group>
...
export default {
  ...
  methods:{
    ...
    async saveDeviceAction(){
      ...
      form.append('parameters', JSON.stringify(this.params))

      if(this.isEdit)
        form.append('_id', this._id)

      await this.saveDevice(form)
      this.loadDevices()
    },
